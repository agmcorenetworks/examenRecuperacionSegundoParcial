...
public class Parte1 {
	...
	//método para lanzar excepción que recibe un número como parámetor
	
	public void lanzarExcepcion(int numero) throws MayorQueException, MenorQueException {

		if (numero > 50) {

			throw new MayorQueException("El número que has introducido es mayor que 50");

		} else if (numero < 50) {

			throw new MenorQueException("El número que has introducido es menor que 50");
	...
	//método para capturar expcciones
